...
project = u'Sensirion SHDLC Python Driver'
copyright = u'{} Sensirion AG, Switzerland'.format(datetime.now().year)
author = u'Sensirion AG'


# The short X.Y version
version = sensirion_shdlc_driver.__version__
# The full version, including alpha/beta/rc tags
release = sensirion_shdlc_driver.__version__
...
htmlhelp_basename = 'PythonDriverforSensirionSHDLCDevices'
